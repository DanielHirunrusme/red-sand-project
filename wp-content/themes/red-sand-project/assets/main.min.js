...
var settings=require("modules/settings"),scrollContainers=require("modules/scrollContainers");module.exports=function(n){function o(){scrollContainers.init(),u.on("resize",t)}function i(){$("body").addClass("noTransition")}function e(){$("body").removeClass("noTransition")}function s(){e()}function t(){clearTimeout(r),i(),r=setTimeout(function(){s()},300)}var r,u=($(n),$(window));o()};
...
var mousewheel=require("jquery-mousewheel"),scrollContainers=module.exports={$window:$(window),initTarget:!1,init:function(){scrollContainers.setRightPanel(),console.log("scrollContainers init"),$(window).on("mousewheel",function(l){scrollContainers.initTarget=l.target.offsetParent,"right-panel"==$(l.target).closest("section").attr("id")?($("#right-panel .main").on("scroll",e),$("#right-panel .main").on("mousewheel",scrollContainers.mouseWheel)):$("#left-panel .main").on("scroll",n),$(window).off("mousewheel")});var e=($("#left-panel .main, #right-panel .main"),function(e){console.log("sync");var n=$("#left-panel .main"),l=n.get(0),o=$("#right-panel .main").scrollLeft()/($("#right-panel .main")[0].scrollWidth-$("#right-panel .main")[0].offsetWidth);l.scrollTop=o*(l.scrollHeight-l.offsetHeight)}),n=function(e){console.log("sync");var n=$("#right-panel .main"),l=n.get(0),o=$("#left-panel .main").scrollTop()/($("#left-panel .main")[0].scrollHeight-$("#left-panel .main")[0].offsetHeight);l.scrollLeft=o*(l.scrollWidth-l.offsetWidth)};$("#right-panel").on("mouseover",function(){$("#right-panel .main").on("scroll",e),$("#right-panel .main").on("mousewheel",scrollContainers.mouseWheel)}).on("mouseout",function(){$("#right-panel .main").off("scroll",e),$("#right-panel .main").off("mousewheel",scrollContainers.mouseWheel)}),$("#left-panel").on("mouseover",function(){$("#left-panel .main").on("scroll",n)}).on("mouseout",function(){$("#left-panel .main").off("scroll",n)})},mouseWheel:function(e){console.log(e.deltaY),$("#right-panel .main").scrollLeft($("#right-panel .main").scrollLeft()-e.deltaY)},setRightPanel:function(){$(".inner-main").css("width",$("#right-panel article").length*$(window).width()),$("#right-panel article").each(function(){$(this).css("left",$(window).width()*$(this).index())})}};
