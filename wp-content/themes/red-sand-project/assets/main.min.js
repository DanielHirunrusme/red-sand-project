...
var mousewheel=require("jquery-mousewheel"),scrollContainers=module.exports={$window:$(window),init:function(){scrollContainers.setRightPanel(),console.log("scrollContainers init");var e=($("#left-panel .main, #right-panel .main"),function(e){console.log("sync");var n=$("#left-panel .main"),l=n.get(0),i=$("#right-panel .main").scrollLeft()/($("#right-panel .main")[0].scrollWidth-$("#right-panel .main")[0].offsetWidth);l.scrollTop=i*(l.scrollHeight-l.offsetHeight)});$("#right-panel .main").on("scroll",e),$("#right-panel .main").on("mousewheel",scrollContainers.mouseWheel)},mouseWheel:function(e){console.log(e.deltaY),$("#right-panel .main").scrollLeft($("#right-panel .main").scrollLeft()-e.deltaY)},setRightPanel:function(){$(".inner-main").css("width",$("#right-panel article").length*$(window).width()),$("#right-panel article").each(function(){$(this).css("left",$(window).width()*$(this).index())})}};
